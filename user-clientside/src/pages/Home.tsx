...
const Home = () => {
  ...
  return (
    <div className="w-full">
      {/* Hero Section */}
      <section className="relative bg-indigo-700 text-white px-4 overflow-hidden min-h-[500px] flex items-center">
        {/* Background image */}
        <div className="absolute inset-0">
          <img
            src="https://www.findbanquet.com/blog/wp-content/uploads/2024/06/photographers.jpg"
        ...
        <div className="relative z-10 container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-indigo-100">
            ...
            knowledge, and experiences. Create posts, take quizzes, and connect
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {featuredPosts.map((post) => (
              ...
              >
                ...
                <div className="font-semibold text-sm mt-2 mb-4">
                  <LikeCounter postId={post.id} refreshTrigger="demo" />
                </div>
              </div>
            ))}
          </div>
